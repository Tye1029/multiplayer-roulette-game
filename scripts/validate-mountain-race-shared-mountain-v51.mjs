...
for (const document of [html, preview]) assert(document.includes('visual=58') || document.includes('visual=57') || document.includes(natural56 ? 'visual=56' : route55 ? 'visual=55' : grounded54 ? 'visual=54' : camera53 ? 'visual=53' : winner52 ? 'visual=52' : 'visual=51'), 'V51/V58 cache boundary is missing');
