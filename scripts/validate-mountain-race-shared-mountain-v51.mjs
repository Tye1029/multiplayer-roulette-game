...
for (const document of [html, preview]) assert(document.includes(grounded54 ? 'visual=54' : camera53 ? 'visual=53' : winner52 ? 'visual=52' : 'visual=51'), 'V51/V54 cache boundary is missing');
