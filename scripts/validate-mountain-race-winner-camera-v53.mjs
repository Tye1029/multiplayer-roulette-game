...
for (const document of [html, preview]) assert(document.includes(natural56 ? 'visual=56' : route55 ? 'visual=55' : grounded54 ? 'visual=54' : 'visual=53'), 'V53/V56 cache boundary is missing');
for (const token of [
