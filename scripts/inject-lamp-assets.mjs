...
const block = `${startMarker}\n` +
  '  <script src="/assets/roulette/lamp-config.js?v=10" defer></script>\n' +
  '  <script src="/assets/roulette/lamp.js?v=10" defer></script>\n' +
  '  <script src="/assets/roulette/lamp-bootstrap.js?v=10" defer></script>\n' +
  `${endMarker}`;
