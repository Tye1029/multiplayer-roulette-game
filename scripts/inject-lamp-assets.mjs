...
const block = `${startMarker}\n` +
  ...
  '  <script src="/assets/roulette/turn-orientation.js?v=3" defer></script>\n' +
  `${endMarker}`;
...
console.log('Injected lamp controls plus stable real-game turn orientation without the legacy flip.');
