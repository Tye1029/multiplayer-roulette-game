...
const block = `${startMarker}\n` +
  ...
  '  <script src="/assets/roulette/audio-bindings.js?v=3" defer></script>\n' +
  `${endMarker}`;
...
console.log('Injected independent lamp, single-sound opening spin, reliable result cues, and unchanged protected animations.');
