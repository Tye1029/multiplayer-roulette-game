...
assert.ok(componentCss.includes("@media(min-width:821px) and (min-height:760px)") && componentCss.includes("min-height:calc(100dvh - 32px)"), "tall desktop tables must use the available viewport instead of leaving a large empty band below play");
