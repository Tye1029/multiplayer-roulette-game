...
assert(html.includes('/assets/fishing/fishing.css?v=fishing-mechanics-v8'), "versioned Fishing stylesheet is not loaded");
assert(html.includes('/assets/fishing/fishing-controller.js?v=fishing-mechanics-v8'), "shared Fishing controller is not loaded");
...
assert(css.includes('top: 44%;\n  width: 60%;\n  height: 72%;'), "dock geometry does not crop both docks beyond the scene edges like the approved preview");
assert(css.includes('.fishing-dock.left { left: -18%;'), "left dock does not continue beyond the left edge");
assert(css.includes('.fishing-dock.right { right: -18%;'), "right dock does not continue beyond the right edge");
assert(css.includes('.fishing-angler.left { left: 20%; }'), "left fisherman is not positioned on the inner dock end");
assert(css.includes('.fishing-angler.right { right: 20%;'), "right fisherman is not positioned on the inner dock end");
