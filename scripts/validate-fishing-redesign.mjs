...
assert(html.includes('/assets/fishing/fishing.css?v=fishing-mechanics-v7'), "versioned Fishing stylesheet is not loaded");
assert(html.includes('/assets/fishing/fishing-controller.js?v=fishing-mechanics-v7'), "shared Fishing controller is not loaded");
...
assert(css.includes('top: 45%;\n  width: 40%;\n  height: 51%;'), "dock geometry does not match the approved lower preview placement");
...
assert(css.includes('animation: fishingLakeBreath 9.5s'), "visible subtle whole-lake motion timing is missing");
