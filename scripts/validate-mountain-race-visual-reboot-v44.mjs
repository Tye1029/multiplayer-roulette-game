...
for (const document of [html, preview]) {
  if (!document.includes(route55 ? 'visual=55' : grounded54 ? 'visual=54' : camera53 ? 'visual=53' : winner52 ? 'visual=52' : shared51 ? 'visual=51' : summit50 ? 'visual=50' : natural49 ? 'visual=49' : finish47 ? 'visual=47' : rugged46 ? 'visual=46' : contact45 ? 'visual=45' : 'visual=44')) fail('V44/V55 cache boundary missing');
...
console.log(`Summit Sprint V44 validation passed for the active ${finish47 ? 'V47 finish-stability presentation' : rugged46 ? 'V46 rugged-terrain presentation' : contact45 ? 'V45 contact-ledges presentation' : 'V44 presentation'}: ${totalBytes} retained bytes, persistent sprite nodes, live holds, non-blocking correct inputs, and protected game runtimes intact.`);
