...
if (!injector.includes("await import('./patch-duel-create-recovery-finalize.mjs');")) throw new Error('Create recovery finalizer is not part of the build.');

console.log('Duel create recovery validation passed: no preflight GET, pointer-only create checks, deterministic recovery IDs, longer timeout, and duplicate-safe escrow statistics.');
