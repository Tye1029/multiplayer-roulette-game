...
const sampleGroups = [
  { name: 'intro sequence', files: ['intro-sequence.b64'], minimumBytes: 12000, sha256: '7a15ecc1c95f91281bf646cc3fc506d1a22c4b8e7a0d8efa3f2ed42fadc2e541' },
...
assert(occurrences(client, '// SAFE_CRACKER_UPLOADED_SOUNDSCAPE_CHUNKS_V2') === 1, 'chunked final-opening marker must appear exactly once');
...
assert(html.includes('&soundscape=2'), 'soundscape=2 cache key is missing');
...
console.log('Uploaded Safe Cracker soundscape validation passed: eight checksum-verified optimized blends made from all nine supplied recordings are decoded, cached, event-scoped, ambience-safe, V16-compatible, and isolated from networking and Roulette.');
