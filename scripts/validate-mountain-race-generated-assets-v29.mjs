...
if (!/visual=(?:31|32|33|34|35|36|37|38)/.test(html) || !/visual=(?:31|32|33|34|35|36|37|38)/.test(preview)) fail('V29 cache boundary missing');
...
for (const alternatives of [['index * 72', 'index * 92'], ['total * 72', 'total * 92'], ['promptIndex - 3) * 72', 'promptIndex - 3) * 92']]) {
