...
assert(html.includes('/assets/safe-cracker/safe-cracker.js?v=6'), 'Safe Cracker JavaScript cache version is not visual-dial v6');
assert(html.includes('/assets/safe-cracker/safe-cracker.css?v=6'), 'Safe Cracker stylesheet cache version is not visual-dial v6');
assert(client.includes('// SAFE_CRACKER_DIAL_PHYSICS_V2_START'), 'visual dial interaction pass is missing');

console.log('Safe Cracker feedback consistency validation passed: feedback remains latched, stale snapshots are rejected, direct completion remains intact, and visual-dial assets are current.');
