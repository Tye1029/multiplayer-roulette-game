...
- The base64 representation is split into six text chunks only to survive GitHub transport, then reassembled and checksum-verified during every production build.
